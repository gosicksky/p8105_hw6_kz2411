...
The distribution of *r̂*<sup>2</sup> is normally skewed. The distribution
of *l**o**g*(*β̂*<sub>0</sub>*β̂*<sub>1</sub>) is also normally skewed.
...
The 95% confidence interval of *(̂**r*)<sup>2</sup> is \[0.894,0.927\]
